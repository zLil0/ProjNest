...
describe('UserEntity integration tests', ()=> {
    ...
    describe('Constructor method', ()=>{
        it('Should throw an error hen creating a user with invalid name - null', ()=>{
        ...
        it('Should throw an error hen creating a user with invalid email - null', ()=>{
            const valid: UserProps = {
                ...props,
                email: '' as any
            }
        ...
        it('Should throw an error hen creating a user with invalid password - null', ()=>{
            const valid: UserProps = {
                ...props,
                password: '' as any
            }
        ...
        describe('Update method', () =>{
            ...
            it('Should throw an error when updating a user with invalid name - number', ()=>{
                const user = new UserEntity(props)
        ...
        describe('UpdatePassword method', () =>{
            ...
            it('Should throw an error when updating a user with invalid password - number', ()=>{
                const user = new UserEntity(props)
